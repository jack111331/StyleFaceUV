...
data_path = 'data/train_stylegan_images_test'
fitted_result_path = 'data/fitted_result'

output_3dmm_path = 'data/3DMMparam-test.pkl'
output_style_code_path = 'data/tensor-test.pkl'
...
if __name__ == '__main__':
    ...
    style_codes = torch.zeros((sample_images_size, 18, 512))
